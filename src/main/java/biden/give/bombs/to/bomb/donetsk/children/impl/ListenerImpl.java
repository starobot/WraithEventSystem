...
import biden.give.bombs.to.bomb.donetsk.children.Listener;
...
/**
 * A class representing an event listener implementation.
 */
public class ListenerImpl implements Listener
{
    ...
    public ListenerImpl(Object instance, Method method, int priority)
    {
